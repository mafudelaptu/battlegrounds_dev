...
<?php
	...
	$retMDR = $MatchDetailsReplay->getMatchesWithoutReplaysOfUser($steamID);
	
	
	$smarty->assign("matches",$retMDR['data']);
	
	$_SESSION['debug'] = "";
	$_SESSION['debug'] = p($retMDR,1);
...
<div id="wrap">
  ...
  <div class="container">
    <?php 
	 			$smarty->display('matchesWithoutReplay/index.tpl');
				?>
  </div>
  <!-- /container -->
  </div>
