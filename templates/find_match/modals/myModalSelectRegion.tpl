...
<div id="myModalSelectRegion" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalSelectRegion" aria-hidden="true">
  <div class="modal-header">
    <h3 id="myModalSelectRegionLabel">Select Region</h3>
  </div>
  <div class="modal-body">
      ...
      {if $regions|count > 0 && $regions|is_array}
          ...
          {for $it=0 to $halfCountRegion}
          	{if $smarty.cookies.singleQueueRegion[$regions.$it.RegionID] == true}
  ...
  <div class="modal-footer">
    <button class="btn btn-primary" onclick="handleRegionSelection()">Save selection!</button>
  </div>
</div>
