...
class GlobalsettingsTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		$globalsettings = array(
			...
			array("name" => "DefaultRegion","value" => "1","active" => 1, "created_at" => new DateTime, "updated_at" => new DateTime, "description" =>"set the the default region of the arena system (INTEGER). Possible values: 1=EU, 2=EUE, 3=USW, 4=USE, 5=RU, 6=SEA, 7=AU/NZ, 8=SA, 9=CH"),
			...
			array("name" => "QuickJoinMatchmode","value" => 9,"active" => 1, "created_at" => new DateTime, "updated_at" => new DateTime, "description" =>"Which matchmode is the quick-join-matchmode (INTEGER, Default:9). Possible values: 1=AP, 2=SD, 3=CM, 4=ARAM, 5=OM, 6=LM, 7=RD, 8=AR, 9=CD, 10=EM, 11=DM"),
			...
			array("name" => "LoginVia","value" => "Forum_IPBoard","active" => 1, "created_at" => new DateTime, "updated_at" => new DateTime, "description" =>"set the primary login method (STRING, Default:'Steam'). Possible values: 'Steam', 'Forum_IPBoard'"),
			array("name" => "ForumLink","value" => "http://dotacinema.localhost/forum/?page=forum","active" => 1, "created_at" => new DateTime, "updated_at" => new DateTime, "description" =>"Link to Forum if LoginVia = 'Forum_IPBoard'  (STRING, Default:'http://forum.link')"),
			array("name" => "ForumHost","value" => "Dotacinema","active" => 1, "created_at" => new DateTime, "updated_at" => new DateTime, "description" =>"Host of the forum if LoginVia = 'Forum_IPBoard' (STRING, Default:'Dotacinema'), Possible values: 'Dotacinema'"),
			...
			array("name" => "ReplayUpload","value" => "Dota2", "active" => 1, "created_at" => new DateTime, "updated_at" => new DateTime, "description" =>"set if Replayupload is possible on match-page,(setting via 'active' column [enabled/disabled]) Default:Dota2. Possible values: Dota2"),
