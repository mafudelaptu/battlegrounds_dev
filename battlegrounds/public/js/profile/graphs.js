	...
	$.ajax({
		...
		success : function(result) {
			...
			if (result.data != null) {
				...
				html = '<div class="alert alert-warning"><p>You have to play at least one match in this Matchmode to view this Chart!</p>' + '<img src="'+ARENA_PATH+'/img/profile/preview/previewPointHistory.png" width="100%">'
						+ '</div>';
	...
	$.ajax({
		...
		success : function(result) {
			...
			if ($(result.keys).size() > 2) {
				...
				html = '<div class="alert alert-warning"><p>You have to play at least one match in more than 2 Matchmodes to view this Chart!</p>' + '<img src="'+ARENA_PATH+'/img/profile/preview/previewPointRose.png" width="100%">'
						+ '</div>';
