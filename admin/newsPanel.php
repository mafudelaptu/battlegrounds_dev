...
<?php
	...
	$News = new News();
	$retN = $News->getNewsCount();
	
	$retN2 = $News->getAllNews();
	
	$smarty->assign('newsCount', $retN['data']);
	$smarty->assign('news', $retN2['data']);
	$_SESSION['debug'] = p($retN2,1);
?>
</head>
  ...
  <div id="wrap">
   <?php 
	...
	<div id="globalBG">
      <div class="container">
      	<?php 
	 			$smarty->display('admin/newsPanel/index.tpl');
				?>
      </div> <!-- /container -->
    </div>
    </div>
