...
$Banlist = new Banlist();
$retB = $Banlist->getBannedPlayers(true);
$retPB = $Banlist->getAllPermaBannedUser();

$smarty->assign('bannedPlayers', $retB['data']);
$smarty->assign('permaBannedPlayers', $retPB['data']);
  ...
  <div id="wrap">
   <?php 
	...
	<div id="globalBG">
      <div class="container">
      	<?php 
	 			$smarty->display('admin/banPanel/index.tpl');
				?>
      </div> <!-- /container -->
    </div>
    </div>
