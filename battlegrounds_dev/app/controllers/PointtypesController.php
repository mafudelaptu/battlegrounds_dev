...
class PointtypesController extends BaseController {
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('admin.pointtypes.index');
		}

		return Redirect::route('admin.pointtypes.create')
			->withInput()
	...
	public function update($id)
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('admin.pointtypes.show', $id);
		}

		return Redirect::route('admin.pointtypes.edit', $id)
			->withInput()
			->withErrors($validation)
			->with('message', 'There were validation errors.');
	}
