...
class MatchmodesTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		switch(App::environment()){
			...
			case "ih":
			$matchmodes = array(
			array("name" => "Constructed Deck Mode", "shortcut" => "CONST", "descr" => "Constructed Deck Mode.", "active" => 1, "created_at" => new DateTime, "updated_at" => new DateTime,"bonus" => 0, "bonus_active" => 1),
			);
				break;
			case "local":
			default:
