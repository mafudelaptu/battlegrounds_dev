...
<table class="table table-striped">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				@include("icons.prizetype", array("prizetype_id"=>$v->prizetype_id, "prizecount"=>$v->prizecount, "prize"=>$v->prize))
			</td>
			<td>
			...
			<td>
				...
				class="t label" title="Minimum Players">{{$v->min_submissions}}</span>
			</td>
		</tr>
		@endforeach
	</tbody>
