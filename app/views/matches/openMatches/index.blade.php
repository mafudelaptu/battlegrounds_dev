...
<table id="openMatchesTable"
	...
	<tbody>
		...
		<tr class="{{$tableClass}}">
			<td>
				<span class="{{$submittedClass}}" title="{{$submittedTitle}}">{{$submittedIcon}}</span>
				{{$check}}
			</td>
			...
			<td><span class="label label-default">{{$submitCountsArray[$v->id]}}</span>
			</td>
		</tr>
