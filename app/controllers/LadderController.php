		...
		*/
		...
		if (isset ( $_GET ['sSearch'] ) && $_GET ['sSearch'] != "") {
			...
			$sWhere = "WHERE (";
				...
				$sWhere .= "u.name LIKE '%".General::mysql_escape_mimic ($_GET['sSearch'])."%' OR u.id LIKE '%".General::mysql_escape_mimic ($_GET['sSearch'])."%'";
				$sWhere .= ')';
}
...
$iTotal = (String) count($rResultWithoutLimit);
		...
		*/
		...
		// if(!empty($_GET['/ladder/getLadderData?sEcho'])){
		// 	$output['sEcho'] = $_GET['/ladder/getLadderData?sEcho'];
		// }
		// else{
