...
class SkillbrackettypesController extends BaseController {
	...
	public function store()
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('admin.skillbrackettypes.index');
		}

		return Redirect::route('admin.skillbrackettypes.create')
			->withInput()
	...
	public function update($id)
	{
		...
		if ($validation->passes())
		{
			...
			return Redirect::route('admin.skillbrackettypes.show', $id);
		}

		return Redirect::route('admin.skillbrackettypes.edit', $id)
			->withInput()
			->withErrors($validation)
			->with('message', 'There were validation errors.');
	}
