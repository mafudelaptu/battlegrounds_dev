...
{
	//return Redirect::to('http://www.dotacinema.com/arena_comingsoon');
...
View::composer("featured.stats", function($view){
	...
	$liveMatchesData = Match::getAllLiveMatches()->get();
	$liveMatches = count($liveMatchesData);
	...
	->with("liveMatches", (int)$liveMatches);
});
...
View::composer("navigation.notification-arena", function($view){
	if(Auth::check()){
